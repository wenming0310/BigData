...
voltagevalue = testdata["电压值"];
voltagevalue = voltagevalue.values;
seaborn.boxplot(voltagevalue[voltagevalue>5000]);

currentvalue = testdata["电流值"];
currentvalue = currentvalue.values;
#seaborn.boxplot(currentvalue[currentvalue>2000]);
